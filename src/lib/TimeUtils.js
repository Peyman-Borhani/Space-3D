export  { MJDToJ2000,       J2000ToMJD,
          JDToMJD,          MJDToJD,
          datetimeToMJD,    MJDToDatetime,
          datetimeToJ2000,  J2000ToDatetime
}

const   MJDToJ2000  =(mjd) => mjd - 51544.5;

const   J2000ToMJD  =(j2000)=> j2000 + 51544.5;

const   JDToMJD     =(JD)=>  JD - 2400000.5;

const   MJDToJD     =(MJD)=> MJD + 2400000.5;
...
const  datetimeToJ2000  =(datetime)=> MJDToJ2000(datetimeToMJD(datetime));

const  J2000ToDatetime  =(j2000)=> MJDToDatetime(J2000ToMJD(j2000));
